...
Once we had the idea for the game in mind, we had to get right to developing it, since we only had three days for the game jam we were participating in. We spent part of the first day conceiving the idea, so the following days we divided into the programming and art teams and got down to developing the game.
...
Finally, you can play QuizzTale in your browser using the following button:
